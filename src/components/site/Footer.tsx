      ...
      <div className="section-shell grid gap-10 py-14 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm text-muted-foreground">
            {SITE.tagline}. {SITE.clientsServed} clients coached through fitness and
        ...
        <div>
          ...
          <div className="mt-4 flex flex-col gap-2 text-sm text-muted-foreground">
            ...
            <Link to="/contact" className="hover:text-foreground">Get in Touch</Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 flex flex-col gap-3 text-sm text-muted-foreground">
            <a href={SITE.youtube} target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-foreground">
            ...
            <a href={`https://wa.me/${SITE.whatsapp.replace(/\D/g, "")}`} target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-foreground">
